...
namespace TodoList
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseDefaultFiles(); // Чтобы можно было обращаться к файлам, типа html по дэфолтным путям
            app.UseStaticFiles(); // Чтобы css/style.css и js/... могли подтягиваться к html файлику
